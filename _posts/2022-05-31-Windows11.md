...
## Most useful settings worth changing on a freshly installed Windows 11
...
2. Issue `vlc-cache-gen .\plugins` and press enter... which generates \plugins\plugins.dat

This brought launch time down to less than a second on my machine.

---

**Solution B** This is the solution I had originally tried, but it only reduced the launch time by about 25%. I'm putting it here for completeness. I did not notice this making much difference after using Solution A above.
...
### **Find images by specific resolution**
